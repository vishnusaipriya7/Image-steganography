...
#======================== SHOW IMAGE ========================================================
y = None  # Initialize y at the start of the script

def show_image():
    global y, images_location
    filename_location = filedialog.askopenfilename(title='Select A File')
    if filename_location:  # Check if a file was selected
        y = filename_location
        images_location = filename_location
